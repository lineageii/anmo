...
public class TechnicianAction extends CrudActionSupport<Technician> {
	...
	private Map<String, String> genderMap = ImmutableMap.of("men", "男",
			"women", "女");
	private int thisyear;
	private Map<String, String> provinceMap = Maps.newHashMap();
	...
	public String input() throws Exception {
		...
		if (entity.getLanguages() == null)
			return INPUT;
		String[] arrays = entity.getLanguages().replace("[", "")
				.replace("]", "").split(",");
	...
	public String save() throws Exception {
		...
		entity.setLanguages(this.checkedLanguages.toString());
