...
<div id="bd">
					...
					<td>&nbsp;
						<security:authorize ifAnyGranted="ROLE_浏览角色">
							<security:authorize ifNotGranted="ROLE_修改角色">
								<a href="role!input.anmo?id=${id}">查看</a>&nbsp;
							</security:authorize>
						</security:authorize>

						<security:authorize ifAnyGranted="ROLE_修改角色">
							<a href="role!input.anmo?id=${id}" id="editLink-${name}">修改</a>&nbsp;
							<a href="role!delete.anmo?id=${id}" id="deleteLink-${name}">删除</a>
						</security:authorize>
					</td>
				</tr>
			</s:iterator>
	...
	<div>
		<security:authorize ifAnyGranted="ROLE_修改角色">
			<a href="role!input.anmo">增加新角色</a>
		</security:authorize>
	</div>
	</div>
	</div>
