...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<s:form id="mainForm" action="technician" method="get">
		...
		<div id="content">
			<table id="contentTable">
				<tr>
					<th><a href="javascript:sort('loginName','asc')">技师编号</a></th>
					<th><a href="javascript:sort('name','asc')">姓名</a></th>
					<th><a href="javascript:sort('email','asc')">性别</a></th>
					<th>年龄</th>
					<th>手机</th>
					<th>QQ</th>
					<th>操作</th>
				...
				<s:iterator value="page.result">
					<tr>
						...
						<td>${thisyear - birthyear}&nbsp;</td>
						<td>${mobileno}</td>
						<td>${qq}</td>
						<td>&nbsp;
							<security:authorize ifAnyGranted="ROLE_浏览用户">
								<security:authorize ifNotGranted="ROLE_修改用户">
									<a href="technician!input.anmo?id=${id}">查看</a>&nbsp;
								</security:authorize>
							</security:authorize>

							<security:authorize ifAnyGranted="ROLE_修改用户">
								<a href="technician!input.anmo?id=${id}">修改</a>&nbsp;
								<a href="technician!delete.anmo?id=${id}">删除</a>
							</security:authorize>
						</td>
					</tr>
				</s:iterator>
		...
		<div>
			...
			<security:authorize ifAnyGranted="ROLE_修改用户">
				<a href="technician!input.anmo">增加新用户</a>
			</security:authorize>
		</div>
	</s:form>
	</div>
