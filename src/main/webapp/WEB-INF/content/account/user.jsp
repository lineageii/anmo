...
<div id="bd">
	<div id="yui-main">
	<div class="yui-b">
	<s:form id="mainForm" anmo="user" method="get">
						...
						<td>&nbsp;
							<security:authorize ifAnyGranted="ROLE_浏览用户">
								<security:authorize ifNotGranted="ROLE_修改用户">
									<a href="user!input.anmo?id=${id}">查看</a>&nbsp;
								</security:authorize>
							</security:authorize>

							<security:authorize ifAnyGranted="ROLE_修改用户">
								<a href="user!input.anmo?id=${id}">修改</a>&nbsp;
								<a href="user!delete.anmo?id=${id}">删除</a>
							</security:authorize>
						</td>
					</tr>
				</s:iterator>
		...
		<div>
			...
			<security:authorize ifAnyGranted="ROLE_修改用户">
				<a href="user!input.anmo">增加新用户</a>
			</security:authorize>
		</div>
	</s:form>
	</div>
