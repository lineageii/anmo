			...
			<div id="main-sub">
				<div id="main">
					...
					<ul id="restList">
						<li><table>
								<tr>
									<th><a href="/tenpo/cafe_merenda"> <img
											src="http://www.laqua.jp/wp-content/uploads/2011/01/merenda-214x142.jpg"
											width="214" height="300" border="0" /> </a><br />
									</th>
									<td class="floor5F">

										<dl>
											<dt>
												<a href="/tenpo/cafe_merenda">名称</a>
											</dt>
											<dd><a href="/tag/可爱风">可爱风</a> <a href="/tag/甜美系">甜美系</a></dd>
										</dl>
										<p class="read_copy">168cm 50kg 22岁</p>
										<p class="body_copy">按摩经验3年</p>
										<p class="body_copy">足疗 指压 油压 </p>
									</td>
								</tr>
							</table></li>
						<li><table>
					...
					<table id="cafeList">
						<caption>
							<img src="images/spa/rest/ttl_cafe.gif" width="660" height="23"
								alt="カフェ" />
						</caption>
						<tr>
							<td><dl>
									<dt class="f5">ラウンジカフェ</dt>

									<dd>
										<a href="/spa_s/relaxation.html#loungeCafe">詳細はこちら&gt;&gt;</a>
									</dd>
								</dl></td>
							<td><dl>
									<dt class="f9">バーデカフェ</dt>
									<dd>
										<a href="/spa_s/healing.html#bardeCafe">詳細はこちら&gt;&gt;</a>
									</dd>
								</dl></td>
						</tr>
					...
					<div class="contentsIn">
						<div id="pageTop" class="pageTop">
							<img src="images/spa/pagetop.gif" width="54" height="12"
								alt="Page Top" />
						</div>
					</div>
					<!-- /.contentsIn -->
				...
				<div id="sub">
					<ul>
						<li><a href="/spa"><img
								src="${ctx}/template/spa/images/snav_ttl.gif" width="185"
								height="60" alt="SPA LAQUA" /> </a></li>
						<li id="snav-news"><a href="/newslist?mode=spa_news"><img
								src="${ctx}/template/spa/images/snav_news.gif" width="96"
								height="21" alt="Spa News" /> </a></li>
						<li id="snav-map"><a href="/map/spa_s.html"><img
								src="${ctx}/template/spa/images/snav_map.gif" width="89"
								height="21" alt="フロアマップ" /> </a></li>

						<li id="snav-zone"><a href="/spa_s/spazone.html"><img
								src="${ctx}/template/spa/images/snav_spa.gif" width="185"
								height="49" alt="SPA ZONE スパ ゾーン" /> </a></li>
